...
public class CreateCourierNegativeTest {
    ...
    public static Object[][]getData(){
        return new Object[][]{
                {null, "123", "Victor", 400, "message", "Недостаточно данных для создания учетной записи"},
                {"Bestcourier", null, "Victor", 400, "message", "Недостаточно данных для создания учетной записи"},
                {null, null, "Victor", 400, "message", "Недостаточно данных для создания учетной записи"},
                {null, null, null, 400, "message", "Недостаточно данных для создания учетной записи"},
                {"Login19", "3405", "есть такой", 409, "message", "Этот логин уже используется. Попробуйте другой."},
                {"Login19", "34052345", "такой же логин", 409, "message", "Этот логин уже используется. Попробуйте другой."}
        };
    }
